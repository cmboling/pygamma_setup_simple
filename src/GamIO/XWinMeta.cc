...
void XWinMeta::SetImag(int im, int old)
  ...
  switch(im)
    ...
    case -1:                                     // First imag parameters old
      ...
      _DISABLE    = string("0");
      _PENCOL     = string("0");
      _FILENAME   = string("<2rr>");
      _CONTRI     = "0";
      break;
    case -2:                                     // Second peak parameters ol
      _TYPNAM     = string("<contadd>");
      _DISABLE    = string("0x1");
      _FILENAME   = string("</u/data/demo/nmr/H5/1/pdata/1/2rr>");
      _CONTRI     = "-1";
      break;
    }
  }
